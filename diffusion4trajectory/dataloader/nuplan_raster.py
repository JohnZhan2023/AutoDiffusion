...
def nuplan_rasterize_collate_func_raw(batch, dic_path=None, autoregressive=False, **encode_kwargs):
    """
    ...
    # online rasterize
    map_func = partial(static_coor_rasterize_raw, data_path=dic_path, **encode_kwargs)
