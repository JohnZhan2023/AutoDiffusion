...
```
python /cephfs/zhanjh/tuplan_garage/nuplan-devkit/nuplan/planning/script/run_nuboard.py simulation_path='[/cephfs/zhanjh/DiffusionForcing/StateTransformer/testing_log/closed_loop_nonreactive_agents/STR_planner/Wednesday_test_whole]' 'scenario_builder=nuplan' 'port_number=5005'
```
